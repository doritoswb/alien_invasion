...
def check_play_button(ai_settings, screen, stats, play_button, ship, mouse_x, mouse_y, aliens, bullets, sb):
...
def check_events(ai_settings, screen, stats, play_button, ship, bullets, aliens, sb):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, stats, play_button, ship, mouse_x, mouse_y, bullets, aliens, sb)
